(function() {
  ...
  const config = {
  "timestamp": "2025-11-21T08:57:34.206Z",
  "repo": {
    "user": "somiibo",
    "name": "productivity-browser-website"
  },
  ...
  "config": {
    "source": "dist",
    "destination": "/home/runner/work/productivity-browser-website/productivity-browser-website/_site",
    "collections_dir": "",
    ...
    "url": "https://productivitybrowser.com",
    "theme": {
      "id": "classy",
      "target": "frontend",
      "appearance": "dark",
    ...
    "meta": {
      "title": "Multi-Account Browser - Productivity Tools - {{ site.brand.name }}",
      "description": "Streamline productive working and multi-account sign-in with {{ site.brand.name }}, built for social media managers, marketers, and growth hackers. Assign different proxies and user agents to tabs, and switch between them in seconds.",
    ...
    "brand": {
      ...
      "description": "Multi-account browser for productive working",
      "type": "Corporation",
      "images": {
    ...
    "cloudflare": {
      "zone": "5b41067ec6eaf34de85f4702faf32d4e"
    },
    "download": {
      "mac": {
        "universal": ""
    ...
    "random_id": 81,
    "canonical": {
      "url": "https://productivitybrowser.com/config.json",
      "path": "/config.json"
    }
  },
  "npm-build": "2025-11-21T08:57:34.206Z"
};
